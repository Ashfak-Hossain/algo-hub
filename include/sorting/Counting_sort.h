/**
 * author: _Berlin_
 * Description: A simple implementation of counting sort for sorting containers with integral types.
...
void counting_sort(std::vector<T>& arr, T min_val, T max_val) {
  static_assert(std::is_integral_v<T>, "Counting sort requires integral types");
